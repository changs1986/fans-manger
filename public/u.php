...
<meta name="keywords" content="PHP组件,PHP探针,UPUPW,ZendOptimizer,eAccelerator,memcache" />
<meta name="description" content="UPUPW PHP环境集成包PHP探针可检测包括Apache和Nginx服务器套件的ZendOptimizer,eAccelerator和memcache等PHP组件。" />
...
<table class="info tablex2">
  <tr>
    ...
    <tr>
    <td class="er">APC 支持</td>
    <td class="fl"><?=phpversion('APC') ? YES : NO ?></td>
  </tr>

    <tr>
    <td class="er">memcache支持</td>
